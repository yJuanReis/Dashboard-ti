...
Esta pasta contém todos os guias de configuração do sistema.

## 📄 Arquivos

### Autenticação e Usuários
- **CONFIGURACAO_LOGIN.md** - Configuração do sistema de login
- **CONFIGURACAO_ADMIN.md** - Como configurar conta de administrador
- **COMO_ATIVAR_ADMIN.md** - Passo a passo para ativar admin
- **GESTAO_USUARIOS_ADMIN.md** - Gestão de usuários pelo admin
