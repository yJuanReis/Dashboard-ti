      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Gestão de Usuários e Acesso Card (Only for Admin) */}
            {realRole === 'admin' && (
              <Card className="hover:shadow-md transition-shadow duration-200">
                <CardHeader className="border-b">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <CardTitle className="text-base">Gestão de Usuários e Acesso</CardTitle>
                    </div>
                  </div>
                  <p className="text-xs text-muted-foreground mt-2">
                    Gerencie usuários do sistema e controle de acesso via Google OAuth.
                  </p>
                </CardHeader>
                <CardContent className="space-y-6 pt-6">
                  {/* Seção 1: Gerenciar Acesso (Google OAuth) */}
                  <div className="border rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-3">
                      <ShieldCheck className="w-4 h-4 text-muted-foreground" />
                      <h4 className="font-semibold text-foreground">Gerenciar Acesso (Google OAuth)</h4>
                    </div>
                  ...
                  <div className="border rounded-lg p-4">
                    ...
                    <p className="text-sm text-muted-foreground mb-4">
                      Adicione um novo usuário ou atualize a senha temporária de um usuário existente. <br />
                      Uma senha aleatória e segura será gerada automaticamente. <br />
                      O usuário deve fazer login e o modal de troca de senha aparecerá automaticamente na Home.
                    </p>
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-3">
                      <h4 className="font-semibold text-foreground">Todos os Usuários</h4>
                      <Button
                        variant="outline"
                        size="sm"
                          ...
                          <Table>
                            <TableHeader className="sticky top-0 z-10 bg-background">
                              <TableRow>
                                ...
                                <TableHead className="bg-background">Acesso</TableHead>
                              ...
                              <div className="space-y-2">
                                <div className="flex items-center justify-between">
                                  ...
                                  <div className="flex gap-1">
                                    ...
                                    <Badge variant="secondary" className="bg-green-100 text-green-800 border-green-200 ml-1 flex-shrink-0">
                                      Google OAuth
                                    </Badge>
                                  </div>
                                </div>
